...
export default class Uploaded extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            visible: false,
            selectBook: null,
            visibleCategoriesAndTags: false,
        }
    ...
    setVisibleCategoriesAndTags = (visible) => {
        this.setState({
            visibleCategoriesAndTags: visible
        })
    }
    ...
    loadList = async () => {
        let loadedList = await getUserPublishBook(this.setBooks)
                                    ...
                                    <View>
                                        ...
                                        >
                                            <Entypo
                                                ...
                                                color='rgba(0,0,0,0.54)'
                                            />
                                            <Text style={styles.textModal}>Huỷ xuất bản</Text>
                                        </TouchableOpacity>
